...
# path the static folder that contains the js, css and img 
...
SECRET_KEY = 'django-insecure-843v2+-nq7(8@9m84lgwj@emf=^q#ppgzqhov=cdu^^qk^1v&9'
...
LOGIN_REDIRECT_URL = 'basic_app:list_post'
